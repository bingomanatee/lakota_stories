...
[![Build Status](https://travis-ci.org/bingomanatee/lakota-stories.svg?branch=master)](https://travis-ci.org/bingomanatee/lakota-stories) [![Dependency Status](https://david-dm.org/bingomanatee/lakota-stories.svg)](https://david-dm.org/bingomanatee/lakota-stories) [![devDependency Status](https://david-dm.org/bingomanatee/lakota-stories/dev-status.svg)](https://david-dm.org/bingomanatee/lakota-stories#info=devDependencies)
...
## Release History
 * 2014-08-05   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)